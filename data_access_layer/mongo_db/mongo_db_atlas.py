...
class MongoDBOperation:
    ...
    def get_mongo_db_url(self):
        ...
        """
        try:
            url = 'mongodb+srv://{0}:{1}@cluster0.dfwdona.mongodb.net/?retryWrites=true&w=majority'.format(
    ...
    def get_database_client_object(self):
        ...
        """
        try:
            client = pymongo.MongoClient(self.get_mongo_db_url(), ssl_cert_reqs=ssl.CERT_NONE)  # creating database client object
            return client
        except Exception as e:
            mongo_db_exception = MongoDbException(
